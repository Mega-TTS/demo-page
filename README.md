...
<img align="center" src="figure/MegaTTS.png" style="  display: block;
  ...
  margin-right: auto;
  width: 100%;"  /></div>
The overall architecture for Mega-TTS. In subfigure (a), P-LLM denotes the prosody large language model; DP & LR denote the duration predictor and length regulator proposed in FastSpeech~\citep{ren2019fastspeech}. In subfigure (b), P-LLM autoregressively predicts the discrete prosody codes.
